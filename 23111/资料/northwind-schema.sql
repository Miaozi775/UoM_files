-- This file is originally from https://github.com/dalers/mywind
-- and is a port of the Northwind sample database distributed with Microsoft Access.
-- The file was modified by Toby Howard so that it would run with a user's default database,
-- instead of creating a new database (`northwind`), which is a privileged
-- operation unsupported in the MySQL implementation in the Department of
