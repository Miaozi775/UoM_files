...
if (len(sys.argv) == 4):
    ...
    elif (sys.argv[4and \texttt{\$opts} can be empty or one of \texttt{-v}, \texttt{-vv} or \texttt{-vvv} where the number of \texttt{v}s indicates an increasing level of detail in the output given by the tests.] == "-vvv"):
